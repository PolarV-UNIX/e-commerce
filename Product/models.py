...
class Category(models.Model):
    ...
    product_id = models.ManyToManyField('Product.Product', verbose_name='product', blank=True)
...
class Product(models.Model):
    ...
    category_id = models.ManyToManyField('Product.Category', verbose_name='category', blank=True)
    ...
    created_at = models.DateTimeField('created_at', auto_now_add=True)
    modify_at = models.DateTimeField('modify_at', auto_now=True)
    rate_id = models.ForeignKey('Product.Rating', on_delete=models.SET_NULL, null=True)
...
class Rating(models.Model):
    rate = models.FloatField('rate', validators=[MinValueValidator(0.0), MaxValueValidator(5.0)], default=3.4)
